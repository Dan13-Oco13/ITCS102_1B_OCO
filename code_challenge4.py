...
# user inputs
exercise = input("What kind of exercise do you want to do? (Calisthenics/Gym/Hybrid): ").lower()
place = input("Where do you plan to exercise? (Indoor gym/Outdoor gym/At home): ").lower()
level = input("What level can you handle? (Light/Heavy): ").lower()
